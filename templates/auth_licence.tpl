...
{tab_header name="groupes" label="Groupes"}
...
<div class="c_full cf">
	...
	<div class="c_full cf">
		<label class="grid_3">Nb de partenaires requis</label>
		<div class="grid_8">
			<input type="text" name="partners" value="{$partners}">{cms_help key='help_partners' title='Nb de partenaires ?'}
		</div>
	</div>
{tab_start name="groupes"}
	<div class="c_full cf">
	...
	<div class="c_full cf">
		...
		<div class="grid_8">
			<select name="ext">{cms_yesno selected=$ext}</select>{cms_help key='help_ext' title='Ouvert à tous ?'}
		</div>
	</div>
	<div class="c_full cf">
