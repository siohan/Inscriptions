...
if(!empty($_POST))
{
	...
	$message = '';	
			...
			if($error < 1)
			{
				if($edit == 0)
				{
					$add = $insc_ops->add_inscription($nom, $description, $date_limite, $date_debut, $date_fin, $actif, $groupe,$group_notif, $choix_multi,$timbre, $occurence, $start_collect, $collect_mode, $end_collect);
					if(true === $add)
					{
				...
				{
					$edit = $insc_ops->edit_inscription($record_id,$nom, $description, $date_limite, $date_debut, $date_fin, $actif,$groupe,$group_notif, $choix_multi,$timbre,$occurence, $start_collect, $collect_mode, $end_collect);
					if(true === $edit)
					{
